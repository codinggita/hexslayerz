...
export class PdfExtractor {
  ...
  static async extract(
    ...
    try {
      console.log("[LSCS] Initializing PDF.js for extraction...");
      ...
      try {
        ...
        console.warn("[LSCS] Failed to read PDF metadata", e);
      }
      ...
      console.error("[LSCS] PDF Extraction failed:", error);
      throw new Error(
